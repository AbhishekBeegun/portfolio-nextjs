...
const NAVBARMOBILE = () => {
  ...
  return (
    <div className="navbar-mobile fixed z-10 top-0 left-0 h-[70px] bg-transparent w-full">
        ...
        <div className={`top-0 z-50 right-0 flex flex-col justify-between text-5xl items-end border-b border bg-black text-white fixed w-full h-[100vh] py-32 px-14 
